# ==================================================== #
# == R code to replicate the left panel of Figure 4 == #
# == Author: Ethan Ancell                           == #
# ==================================================== #
...
cat("Simulating for Figure 4 - left panel\n")
...
# saveRDS(estimates_thinning, file = "saved_simulation_data/figure_4_left_estimates_thinning.RDS")
# saveRDS(targets_thinning, file = "saved_simulation_data/figure_4_left_targets_thinning.RDS")
# saveRDS(variances_thinning, file = "saved_simulation_data/figure_4_left_variances_thinning.RDS")
# saveRDS(estimates_naive, file = "saved_simulation_data/figure_4_left_estimates_naive.RDS")
# saveRDS(targets_naive, file = "saved_simulation_data/figure_4_left_targets_naive.RDS")
# saveRDS(variances_naive, file = "saved_simulation_data/figure_4_left_variances_naive.RDS")

estimates_thinning <- readRDS("saved_simulation_data/figure_4_left_estimates_thinning.RDS")
targets_thinning <- readRDS("saved_simulation_data/figure_4_left_targets_thinning.RDS")
variances_thinning <- readRDS("saved_simulation_data/figure_4_left_variances_thinning.RDS")
estimates_naive <- readRDS("saved_simulation_data/figure_4_left_estimates_naive.RDS")
targets_naive <- readRDS("saved_simulation_data/figure_4_left_targets_naive.RDS")
variances_naive <- readRDS("saved_simulation_data/figure_4_left_variances_naive.RDS")
