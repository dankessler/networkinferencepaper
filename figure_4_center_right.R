# ================================================================= #
# == R code to replicate the center and right panels of Figure 4 == #
# == Author: Ethan Ancell                                        == #
# ================================================================= #
...
cat("Simulating for Figure 4 - center and right panels\n")
...
# saveRDS(estimates_thinning, file = "saved_simulation_data/figure_4_center_right_estimates_thinning.RDS")
# saveRDS(targets_thinning, file = "saved_simulation_data/figure_4_center_right_targets_thinning.RDS")
# saveRDS(variances_thinning, file = "saved_simulation_data/figure_4_center_right_variances_thinning.RDS")
# saveRDS(rand_results, file = "saved_simulation_data/figure_4_center_right_rand_results.RDS")

estimates_thinning <- readRDS("saved_simulation_data/figure_4_center_right_estimates_thinning.RDS")
targets_thinning <- readRDS("saved_simulation_data/figure_4_center_right_targets_thinning.RDS")
variances_thinning <- readRDS("saved_simulation_data/figure_4_center_right_variances_thinning.RDS")
rand_results <- readRDS("saved_simulation_data/figure_4_center_right_rand_results.RDS")
