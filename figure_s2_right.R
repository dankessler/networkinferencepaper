# ====================================================== #
# == R code to replicate the right panel of Figure S2 == #
# == Author: Ethan Ancell                             == #
# ====================================================== #
...
variances_thinning <- readRDS("saved_simulation_data/figure_s2_right_variances_thinning.RDS")
estimates_naive <- readRDS("saved_simulation_data/figure_s2_right_estimates_naive.RDS")
targets_naive <- readRDS("saved_simulation_data/figure_s2_right_targets_naive.RDS")
variances_naive <- readRDS("saved_simulation_data/figure_s2_right_variances_naive.RDS")
