...
# saveRDS(estimates_thinning, file = 'save_data/poisson_heterogeneous_ciwidth_estimates_thinning.RDS')
# saveRDS(targets_thinning, file = 'save_data/poisson_heterogeneous_ciwidth_targets_thinning.RDS')
# saveRDS(variances_thinning, file = 'save_data/poisson_heterogeneous_ciwidth_variances_thinning.RDS')
# saveRDS(estimates_naive, file = 'save_data/poisson_heterogeneous_ciwidth_estimates_naive.RDS')
# saveRDS(targets_naive, file = 'save_data/poisson_heterogeneous_ciwidth_targets_naive.RDS')
# saveRDS(variances_naive, file = 'save_data/poisson_heterogeneous_ciwidth_variances_naive.RDS')
# saveRDS(covered_thinning, file = 'save_data/poisson_heterogeneous_ciwidth_covered_thinning.RDS')
# saveRDS(covered_naive, file = 'save_data/poisson_heterogeneous_ciwidth_covered_naive.RDS')

estimates_thinning <- readRDS('save_data/poisson_heterogeneous_ciwidth_estimates_thinning.RDS')
targets_thinning <- readRDS('save_data/poisson_heterogeneous_ciwidth_targets_thinning.RDS')
variances_thinning <- readRDS('save_data/poisson_heterogeneous_ciwidth_variances_thinning.RDS')
estimates_naive <- readRDS('save_data/poisson_heterogeneous_ciwidth_estimates_naive.RDS')
targets_naive <- readRDS('save_data/poisson_heterogeneous_ciwidth_targets_naive.RDS')
variances_naive <- readRDS('save_data/poisson_heterogeneous_ciwidth_variances_naive.RDS')
covered_thinning <- readRDS('save_data/poisson_heterogeneous_ciwidth_covered_thinning.RDS')
covered_naive <- readRDS('save_data/poisson_heterogeneous_ciwidth_covered_naive.RDS')
...
figure2a
ggsave('figures/poisson_heterogeneous_ciwidth.pdf',
